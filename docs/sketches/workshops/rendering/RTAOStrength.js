...
function preload() {
    img = loadImage("/vc/docs/sketches/workshops/rendering/global_illumination/Strenght0.webp");
    img2 = loadImage("/vc/docs/sketches/workshops/rendering/global_illumination/Strenght1.webp");
}
...
function setup() {
    ...
    let text1 = createElement('text1', 'Direct Lighting Strength 0');
    text1.position(100,590);
    text1.style('font-weight', 'bold');
    text1.style('font-size', '20px');
    let text2 = createElement('text2', 'Direct Lighting Strength 1');
    text2.position(480, 590);
