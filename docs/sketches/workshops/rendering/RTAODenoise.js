...
function preload() {
    img = loadImage("/vc/docs/sketches/workshops/rendering/global_illumination/DenoiseOFF.webp");
    img2 = loadImage("/vc/docs/sketches/workshops/rendering/global_illumination/DenoiseON.webp");
}
...
function setup() {
    ...
    let text1 = createElement('text1', 'Denoise OFF');
    text1.position(170,590);
    text1.style('font-weight', 'bold');
    text1.style('font-size', '20px');
    let text2 = createElement('text2', 'Denoise ON');
    text2.position(550, 590);
