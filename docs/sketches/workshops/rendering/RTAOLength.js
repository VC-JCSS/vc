...
function preload() {
    img = loadImage("/vc/docs/sketches/workshops/rendering/global_illumination/RayLenght0.5.webp");
    img2 = loadImage("/vc/docs/sketches/workshops/rendering/global_illumination/RayLenght12.webp");
}
...
function setup() {
    ...
    let text1 = createElement('text1', 'Ray Length 0.5');
    text1.position(150,590);
    text1.style('font-weight', 'bold');
    text1.style('font-size', '20px');
    let text2 = createElement('text2', 'Ray Length 12');
    text2.position(530, 590);
