...
function draw() {
    ...
    let mosaic_part_x =20;
    let mosaic_part_y =20;
...
function searchImage(color, x, y, w, h){
    ...
    loadImage(`/vc/docs/sketches/workshops/imaging/mosaic/html_colors/${color_min.substring(1,color_min.length)}.jpg`, img_color =>{
